<template>
  <div class="flex flex-col items-center gap-[40px]">
    ...
    <div class="bg-[#F36123] p-5 font-[500] text-white text-medium rounded-full cursor-pointer shadow-xl">XEM THÊM SẢN PHẨM VỀ  {{ ProCate.productCate.categoryName.toUpperCase() }}</div>
  </div>
</template>
