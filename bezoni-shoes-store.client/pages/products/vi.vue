  ...
  <div class="py-[20px]">
    <div class="flex flex-row gap-2 text-[20px] mb-[20px] items-center">
      ...
      <NuxtLink
        ...
        >Home /</NuxtLink
      >
      <div class="font-semibold">Ví</div>
    </div>
    <div class="flex grid grid-cols-10 gap-5">
      ...
      >
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex flex-col items-center gap-2">
            <div class="text-[17px] font-[500]">Sắp xếp giá</div>
            <div class="flex gap-2 relative">
              <select
                class="w-[200px] h-[20px] border border-gray-300 rounded-md p-4"
...
watch(selectedSort, () => {
  switch (selectedSort.value) {
    case 1:
      giayProducts.sort(
        (a, b) =>
          roundNumber(a.price * (1 - a.voucher / 100)) -
          roundNumber(b.price * (1 - b.voucher / 100))
      );
      break;
    case 2:
      giayProducts.sort(
